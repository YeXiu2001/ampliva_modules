...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#test tbody').on('click', 'td.details-control', function () {
            ...
            if (row.child.isShown()) {
                ...
                // Start building the nested table
                let nestedTable = `
                ...
                adgroupData.forEach(adg => {
                    nestedTable += `
                        <tr>
                            ...
                            <td>${escapeHtml(adg.adgroup_name)}</td>
                            <td>${escapeHtml(adg.ad_count)}</td>
                            <td>${escapeHtml(adg.impressions)}</td>
                            <td>${escapeHtml(adg.ctr)}</td>
                            <td>${escapeHtml(adg.cpc)}</td>
                            <td>${escapeHtml(adg.cpm)}</td>
                            <td>${escapeHtml(adg.clicks)}</td>
                            <td>${escapeHtml(adg.reach)}</td>
                            <td>Show Metrics</td>
                        </tr>
                    `;
                });
        ...
        $('#metrics-select').on('change', function() {
            ...
            hideMetricCols(); //hide not needed cols at first
    ...
    function formatAdgroupRow(data) {
